...
RBX_SEND_MASTER_NODES_REQUIRES_WHITELIST = ENV.bool(
    "RBX_SEND_MASTER_NODES_REQUIRES_WHITELIST", default=True
)
RBX_SEND_MASTER_NODES_WHITELIST = ENV.list(
    "RBX_SEND_MASTER_NODES_WHITELIST", cast=str, default=[]
)
